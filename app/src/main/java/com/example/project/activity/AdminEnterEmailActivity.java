    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (email.equals("")){
                    Toast.makeText(AdminEnterEmailActivity.this, "Email không được bỏ trống", Toast.LENGTH_SHORT).show();
                }
                else if (!(email.matches(emailPattern)))
                {
                    Toast.makeText(AdminEnterEmailActivity.this, "Email không hợp lệ", Toast.LENGTH_SHORT).show();
                }
                else if (checkadminemail == false)
                {

                    Toast.makeText(AdminEnterEmailActivity.this, "Email chưa được đăng ký", Toast.LENGTH_SHORT).show();
                }
                else {
